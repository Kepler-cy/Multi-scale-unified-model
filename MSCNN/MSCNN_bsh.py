...
class MScnn(nn.Module)
    ...
    def forward(self, adj_mind, memory_county_local,memory_county_global, attraction_county, memory_community, attraction_community, device):
        ...
        return county_out5.squeeze(1), final_output, community_output,community_output_m_county,community_out4,county_out5.squeeze(1).argmax(1)
