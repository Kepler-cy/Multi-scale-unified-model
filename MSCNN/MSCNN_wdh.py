...
class MScnn(nn.Module): 
    def __init__(self, H_Dim1, H_Dim2):
        ...
        self.conv22 = nn.Sequential(
            nn.Conv1d(16, 16, 3, 1, 1, bias=False), # [64, 32, 124] 32
            nn.ReLU(),
        )
        self.conv23 = nn.Sequential(
            nn.Conv1d(16, 16, 3, 1, 1, bias=False), # [128, 1, 256] 32
            nn.ReLU(),
        )
        self.conv24 = nn.Sequential(
            nn.Conv1d(16, 1, 3, 1, 1, bias=False), # [128, 1, 256] 32
            nn.ReLU(),
        )
    ...
    def forward(self, adj_mind, memory_county_local,memory_county_global, attraction_county, memory_community, attraction_community, device):
        ...
        community_output = community_out4.view(batch_number, county_number, community_number)#(64, 124, 80)
        ...
        return county_out5.squeeze(1), final_output, community_output,community_output_m_county,community_out4,community_out4.squeeze(1).argmax(1)
